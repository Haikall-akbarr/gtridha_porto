...
export default function SkillBentoGrid() {
  ...
  return (
    <motion.div 
      ...
      className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto md:auto-rows-[220px]"
    >
      {/* Hard Skills (Mendominasi 2 kolom) */}
      <motion.div 
        variants={itemVariants}
        className="md:col-span-2 bg-gradient-to-br from-pink-600 to-pink-500 rounded-[2.5rem] p-8 text-white shadow-lg shadow-pink-200 flex flex-col justify-end overflow-hidden relative group min-h-[220px]"
      >
      ...
      <motion.div 
        variants={itemVariants}
        className="bg-white rounded-[2.5rem] p-8 border border-pink-100 shadow-sm flex flex-col justify-center hover:shadow-xl hover:shadow-pink-100/50 transition-shadow min-h-[220px]"
      >
      ...
      >
        ...
        <div className="md:w-2/3 flex flex-wrap justify-start md:justify-end gap-3 mt-4 md:mt-0">
